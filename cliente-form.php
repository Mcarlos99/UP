...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($modo === 'criar') {
            ...
            $stmt = $db->prepare("INSERT INTO clientes (nome, email, telefone, cpf_cnpj, cep, endereco, numero, complemento, bairro, cidade, estado, observacoes, empresa_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)

            ");

            $stmt->execute([

                $nome, $email, $telefone, $cpf_cnpj, $cep, $endereco, $numero,
            ...
            $stmt = $db->prepare("
                ...
                UPDATE clientes SET
                    ...
                    nome = ?, email = ?, telefone = ?, cpf_cnpj = ?, cep = ?, 
